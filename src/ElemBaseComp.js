...
function ElemBaseComp({midstr, islocked=false, showbtns, canremthis, getitem, setitem, addtothis,
    remfromthis})
{
    ...
    return (<div id={midstr} style={{display: "inline-block"}}>
        ...
        {(islocked ? (<span style={{paddingRight: "10px",
            display: ((mitem.base === 1) ? "none" : "inline-block")}}><b>{mitem.base}</b></span>) :
